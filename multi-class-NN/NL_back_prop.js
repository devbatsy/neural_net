class back_prop
{
    constructor(neural,error,label)
    {
        this.neural = neural;
    ...
    {
        const {neural, cost,true_label} = level;
        ...
        neuron_keys.forEach(val =>
            {
                neural.neurons[val].forEach((neuron,index) =>
                    {
                            ...
                            neuron['w_b4'].forEach(weight_1 =>
                                {
                                    ...
                                    switch(true)
                                    {
                                        ...
                                        break;
                                        case ref_target['activation_func'] === 'Lrelu':
                                        ...
                                        case ref_target['activation_func'] === 'sigmoid':
                                            ...
                                            break;
                                        case ref_target['activation_func'] === '':
                                            // console.log(true_label)
                                            if(true_label[index] === 1)
                                            {
                                                target_sig_derivate = (ref_target_val-1)
                                            }else
                                            {
