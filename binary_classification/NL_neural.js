class neural_network{
    constructor(input,output){
        ...
        this.links = {};
        this.Number_layer = 3;
        this.output_activation = 'relu'
        this.layer_1 = input;
        this.input_params = null;
        this.output_params = null;
        this.layer_hidden = [[20,'relu'],[15,'relu'],[1,'relu']];//2 15//perfect training 70 1layer
    ...
    static links_create(level){
        ...
        const ret = (i,j) =>
        {
            ...
            for(let k = 0; k < neurons[`${i+1}`].length; k++)
            {
                ...
                obj['weight'] = Math.sqrt(1/neurons[`${i}`].length) * Math.random()
